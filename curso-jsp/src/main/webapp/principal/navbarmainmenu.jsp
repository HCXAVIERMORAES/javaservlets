       ...
       <ul class="pcoded-item pcoded-left-item">
           ...
           <li class="pcoded-hasmenu">
               ...
               <ul class="pcoded-submenu">
                   ...
                   <!-- demais botões não usados se houver acrescimo de mais cadastros é só descomentar
                   <li class=" ">
       ...
       <ul class="pcoded-item pcoded-left-item">
           <li>
               <a href="<%= request.getContextPath() %>/principal/reluser.jsp" class="waves-effect waves-dark">
                   ...
                   <span class="pcoded-mtext" data-i18n="nav.form-components.main">Rel. Usuário</span>
                   <span class="pcoded-mcaret"></span>
               </a>
           </li>
