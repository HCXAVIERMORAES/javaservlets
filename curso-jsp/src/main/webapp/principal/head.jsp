...
<head>
    <title>Curso JDev Treinamento</title>
    <!-- Suporte ao Shim and Respond.js IE10 de elementos HTML5 e consultas de mídia -->
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="Projeto de estudo feito em JSP." />
      <meta name="author" content="Helton c x Moraes" />
      <!-- Favicon icon -->
