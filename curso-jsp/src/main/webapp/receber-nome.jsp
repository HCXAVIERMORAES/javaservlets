...
<body>
	<!-- pagina apagada. em seu lugar ficara o serveletLogin. Esta é apenas para teste
	...
	Para passar o parâmetro, na barra do navegador após o .jsp digita-se: ?variavel = valor, ou seja, ?nome=Helton
